...
if( isset( $_POST["add"])){
   ...
   if( $assistant_id && $type && $destination && $start_date && $end_date){

            $query = "INSERT INTO  assistantout (assistant_id,type,destination,start_date,end_date)
	VALUES ('$assistant_id','$type','$destination','$start_date','$end_date')";
 ...
 include ("../../../includes/header/header/header.php");
    ...
    ?>
<div class="container">
        <h2 class="page-header">قيام مأمورية / فرقة صف ضباط</h2>
		<?php
			echo $usedBefore;
			echo $requiredError;
			echo $invalidEmail;
