...
$query = "SELECT * FROM  assistantperiodical WHERE id='$assistantID'";
...
if( isset( $_POST['update'] ) ){
    ...
    $date   = validateFormData($_POST['date']);
       ...
       $query = "UPDATE assistantperiodical SET assistant_id = '$assistant_id',"
       ."date = '$date' WHERE id = $assistantID";
...
if(isset( $_POST['confirm-delete'] )){
           // new database query & result
            $query = "DELETE FROM assistantperiodical WHERE id='$assistantID'";
            $result = mysqli_query($conn,$query);
            if($result){
                header("Location: assistants.php");
            }else{
