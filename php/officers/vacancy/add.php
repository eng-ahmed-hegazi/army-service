...
if( isset( $_POST["add"])){
   ...
   if( $officer_id && $type && $start_date && $end_date){

            $query = "INSERT INTO  officervacancy (officer_id,type,start_date,end_date)
	VALUES ('$officer_id','$type','$start_date','$end_date')";
       ...
       $requiredError = "<div class='alert alert-danger a' style='font-size: 18px'>الرقم العسكرى والأسم مطلوبين *<a class='close' data-dismiss='alert'>&times;</a></div>";
   }
}
 ...
 include ("../../../includes/header/header/header.php");
    ...
    ?>
<div class="container">
        <h2 class="page-header">قيام أجازة ضابط</h2>
		<?php
			echo $usedBefore;
			echo $requiredError;
			echo $invalidEmail;
