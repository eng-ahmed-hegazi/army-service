...
$query = "SELECT * FROM  officervacancy WHERE id='$officerID'";
...
if( isset( $_POST['update'] ) ){
    ...
    $types   = validateFormData($_POST['type']);
   ...
   if($officer==$officer_id ){
       // new database query & result
       $query = "UPDATE officervacancy SET officer_id = '$officer_id',type='$types',start_date='$start_date',end_date='$end_date' WHERE id = $officerID";
   }else{
...
if(isset( $_POST['confirm-delete'] )){
			$query1 = "SELECT * FROM officervacancy WHERE id='$officerID' LIMIT 1";
           ...
           // new database query & result
            $query = "DELETE FROM officervacancy WHERE id='$officerID'";
            $result = mysqli_query($conn,$query);
