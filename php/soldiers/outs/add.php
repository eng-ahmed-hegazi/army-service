...
if( isset( $_POST["add"])){
   ...
   if( $soldier_id && $type && $destination){

            $query = "INSERT INTO  soldierout (soldier_id,type,destination,start_date,end_date)
	VALUES ('$soldier_id','$type','$destination','$start_date','$end_date')";
 ...
 include ("../../../includes/header/header/header.php");
    ...
    ?>
<div class="container">
        <h2 class="page-header">قيام مأمورية / فرقة جنود</h2>
		<?php
			echo $usedBefore;
			echo $requiredError;
			echo $invalidEmail;
