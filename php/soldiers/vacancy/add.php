...
if( isset( $_POST["add"])){
   ...
   if( $soldier_id && $type && $start_date && $end_date){

            $query = "INSERT INTO  soldiervacancy (soldier_id,type,start_date,end_date)
...
<div class="container">
		...
		?>
        <h2 class="page-header">قيام أجازة جنود [<?php echo $sarya?>]</h2>
		<?php
			echo $usedBefore;
			echo $requiredError;
			echo $invalidEmail;
